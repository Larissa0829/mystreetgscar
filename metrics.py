...
def evaluate(split='test'):
    ...
    for method in os.listdir(test_dir):
        ...
        for cam_info in tqdm(cam_infos, desc="Reading image progress"):
            ...
            render_path = test_dir / method / "render" / f'{image_name}_rgb.png'
    ...
    with open(scene_dir + f"/results_all_{split}.json", 'w') as fp:
        json.dump(full_dict[scene_dir], fp, indent=True)
    with open(scene_dir + f"/per_view_all_{split}.json", 'w') as fp:

...
for scene in "${scenes[@]}"; do
    for index in "${indexs[@]}"; do
        ...
        python render.py --config configs/example/waymo_train_${scene}_${index}.yaml mode trajectory render_dir_name trajectory_right render_move_y -10 render_rotate_z 90

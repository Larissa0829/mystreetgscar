...
parser.add_argument("--render_dir_name", type=str, default="")
parser.add_argument("--render_move_y", type=int, default=0)
parser.add_argument("--render_rotate_z", type=int, default=0)
